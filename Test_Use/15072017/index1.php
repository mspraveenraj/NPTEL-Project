...
<div>
	<center><div id="center" style="position:relative; width:100%; height:100%">
...
<table width="100%" border="2" width="100%" cellpadding="20" cellspacing="20">
  ...
  <tr>
    ...
    <td><a href="short/NPTEL/NPTEL Index/basic_courses.php" id="linked" target="_blank">Basic courses(Sem 1 and 2)</a></td>
  ...
  <tr>
    ...
    <td><a href="short/NPTEL/NPTEL Index/chemical.php" id="linked" target="_blank">Chemical Engineering</a></td>
    ...
    <td><a  href="short/NPTEL/NPTEL Index/css.php" id="linked" target="_blank">Computer Science and Engineering</a></td>
  ...
  <tr>
    ...
    <td><a href="short/NPTEL/NPTEL Index/ece.php" id="linked" target="_blank">Electronics & Communication Engineering</a></td>

    <td><a href="short/NPTEL/NPTEL Index/engg_design.php" id="linked" target="_blank">Engineering Design</a></td>
  ...
  <tr>
    ...
    <td><a href="short/NPTEL/NPTEL Index/management.php" id="linked" target="_blank">Management</a></td>
  ...
  <tr>
    ...
    <td><a href="short/NPTEL/NPTEL Index/mining.php" id="linked" target="_blank">Mining Engineering</a></td>
