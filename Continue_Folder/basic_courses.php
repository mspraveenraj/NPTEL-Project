...
<form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select2" id="select2" onchange="goToPage('select2');"><option  value="#">Select </option>
      ...
      <option  value="122101001/Engineering%20Chemistry%20I/Course%20Objectives.html">contents</option>
 ...
 <form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select3" id="select3" onchange="goToPage('select3');"><option  value="#">Select </option>
      ...
      <option  value="122101002/Engineering%20Physics%20II/Course%20Objectives.html">contents</option>
 ...
 <form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select2" id="select2" onchange="goToPage('select2');"><option  value="#">Select </option>
      ...
      <option  value="122101003/Mathematics%20I/Course%20Objectives.html">contents</option>
...
<form name="jk123" action="displayvideo.html" method="get" target="_blank">
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122102006/Environment and Ecology/index.htm">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122103010/engg_phy2/index_exp.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122103011/engg_physics/index_cont.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122103012/maths3/index.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122104013/esc102/index.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122104014/engg_mechanics/ui/About-Faculty.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122104014/mathematics-2/index.html">contents</option>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122104019/Numerical Analysis/front.htm">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122106026/Basic_Electronics_Lab/index.php">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122106029/Engineering_Chemistry_III/index.php">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122106030/Enivironmental_Chemistry_Analysis/index.php">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122106031/Management_Science_I/index.php">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="122106032/Management_Science_II/index.php">contents</option>
