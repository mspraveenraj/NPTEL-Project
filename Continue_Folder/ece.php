...
<form name="jk123" action="displayvideo.html" method="get" target="_blank">
	...
	<td><select name="select1" id="select1" onchange="goToPage('select1');"><option  value="#">Select </option>
      ...
      <option  value="117101054/Optical%20Communication/Course%20Objective.htm">contents</option>
 ...
 <form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select2" id="select2" onchange="goToPage('select2');"><option  value="#">Select </option>
      ...
      <option  value="117101057/Transmission%20Lines%20and%20EM%20Waves/Course%20Objective.htm">contents</option>
 ...
 <form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select3" id="select3" onchange="goToPage('select3');"><option  value="#">Select </option>
      ...
      <option  value="117101058/VLSI%20Design/Course%20Objective.htm">contents</option>
 ...
 <form name="jk123" action="displayweb.html" method="get" target="_blank">
	...
	<td><select name="select4" id="select4" onchange="goToPage('select4');"><option  value="#">Select </option>
      ...
      <option  value="117101055/Signals%20and%20System/Course%20Objective.htm">contents</option>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117102061/Semiconductor%20Devices/index.htm">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117103064/digital_circuit/frame/index.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117103065/em/index.htm">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117103066/ic_tech/index.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117103067/probability_rp/index.htm">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117104069/Digi_Img_Pro/ui/About-Faculty.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117104070/Digi_Sign_Pro/ui/About-Faculty.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117104071/HighSpeed_SemiconductorDevices/ui/About-Faculty.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117104072/microcontrollers/micro/ui/About-Faculty.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117105076/Communication%20network/New_index1.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117105077/Digi%20Comm/New_index1.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117105083/Multimedia Processing/New_index1.html">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117107094/Analog circuits/index.htm">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117107095/BASIC-ELECTRONICS/home_page.htm">contents</option></select></td></tr></form>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117108097/Information Theory and Coding/Learning Material - ITC.pdf">contents</option></select></td></tr></form>
	...
	<td> <select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117103017/module1/index.html">Introduction to Queueing Systems</option>
      
      <option  value="117103017/module1/lec2/1.html">Analysis of a Simple Queue</option>
      
      <option  value="117103017/module2/lec1/1.html">Basics of Markov Processes and Markov Chains</option>
      
      <option  value="117103017/module2/lec2/1.html">Markov Chains, Birth-Death Processes, Flow Balance</option>
      
      <option  value="117103017/module3/lec1/1.html">Kendall's Notation, Little's Result, PASTA, M/M/1/&#8734; Queue</option>
      
      <option  value="117103017/module3/lec2/1.html">M/M/m/&#8734;, M/M/m/m, M/M/1/K Queues, Delay Analysis</option>
      
      <option  value="117103017/module4/lec1/1.html">Departure Process, Burke's Theorem</option>
      
      <option  value="117103017/module4/lec2/1.html">Method of Stages, Batch Arrivals</option>
      
      <option  value="117103017/module5/lec1/1.html">Residual Life Approach</option>
      
      <option  value="117103017/module5/lec2/1.html">Imbedded Markov Chain Approach</option>
      
      <option  value="117103017/module5/lec3/1.html">Delay Analysis</option>

      
      <option  value="117103017/module6/lec1/1.html">Analysis of M/G/1 queue</option>
      
      <option  value="117103017/module7/lec1/1.html">M/G/1 Queue with Multiple  Vacations, Residual Life Approach</option>
      
      <option  value="117103017/module7/lec2/1.html">M/G/1 Queue with Multiple Vacations Imbedded Markov Chain Approach</option>
      
      <option  value="117103017/module7/lec3/1.html">M/G/1 Queue with Multiple Vacations, M/G/1 Queue with Exceptional First Service</option>
      
      <option  value="117103017/module8/lec1/1.html">Imbedded Markov Chain at Job Departure Instants</option>
      
      <option  value="117103017/module8/lec2/1.html">Imbedded Markov Chain at Batch Departure Instants</option>
      
      <option  value="117103017/module9/lec1/1.html">Different Types of Priority Operation</option>
      
      <option  value="117103017/module9/lec2/1.html">Analysis using the Residual Life Approach</option>
      
      <option  value="117103017/module9/lec3/1.html">Analysis using the Imbedded Markov Chain Approach</option>
      
      <option  value="117103017/module10/lec1/1.html">M/G/1/K Queue (Single Server Queue with Finite Capacity)</option>
      
      <option  value="117103017/module10/lec2/1.html">Analysis of the M/G/1/K queue</option>
      
      <option  value="117103017/module10/lec3/1.html">Proportionality Relationship, Alternate Analysis</option>
      
      <option  value="117103017/module11/lec1/1.html">Analyzing  the G/M/1 Queue</option>
      
      <option  value="117103017/module11/lec2/1.html">Bounds and approximations for the G/G/1 and G/G/m Queues</option>
      
      <option  value="117103017/module11/lec3/1.html">Analyzing the M/G/m/m Queue</option>
      
      <option  value="117103017/module12/lec1/1.html">Introduction to Queuing Networks</option>
      
      <option  value="117103017/module12/lec2/1.html">Classificationof Queueing Networks</option>
      
      <option  value="117103017/module12/lec3/1.html">Fork-join Queues and Introduction to Blocking in Queueing Networks</option>
      
      <option  value="117103017/module12/lec4/1.html">Blocking Models in queueing Networks</option>
      
      <option  value="117103017/module13/lec1/1.html">Splitting and Combining Poisson Processes</option>
      
      <option  value="117103017/module13/lec2/1.html">Jackson's Theorem for Open Networks</option>
      
      <option  value="117103017/module13/lec3/1.html">Product Form Solution for Open Networks</option>
      
      <option  value="117103017/module13/lec4/1.html">Jackson's Theorem for Closed Networks</option>
      
      <option  value="117103017/module13/lec5/1.html">Using Jackson's Theorem for Closed Networks</option>
      
      <option  value="117103017/module13/lec6/1.html">Examples: Analysis of Open and closed Networks</option>
      
      <option  value="117103017/module14/lec1/1.html">Analysis of Closed Networks</option>
      
      <option  value="117103017/module14/lec2/1.html">Convolution Algorithm</option>
      
      <option  value="117103017/module14/lec3/1.html">Examples of analysis using Convolution Algorithm</option>
      
      <option  value="117103017/module14/lec4/1.html">Mean Value Analysis Algorithm</option>
      
      <option  value="117103017/module14/lec5/1.html">Examples of Analysis using MVA Algorithm</option>
      
      <option  value="117103017/module15/lec1/1.html">Norton's Theorem</option>
      
      <option  value="117103017/module15/lec2/1.html">Mixed Networks, QNA</option>
      
      <option  value="117103017/module16/lec1/1.html">Introduction to Discrete Time Queues</option>
      
      <option  value="117103017/module16/lec2/1.html">Geo/G/1 Queue-Late Arrival Model</option>
      
      <option  value="117103017/module16/lec3/1.html">Geo/G/1 Queue- early Arrival Model</option>
      
      <option  value="117103017/module17/lec1/1.html">Introduction</option>
      
      <option  value="117103017/module17/lec2/1.html">Simulating a Queueing System</option>
      
      <option  value="117103017/module17/lec3/1.html">Processing Simulation Results</option>
      
      <option  value="117103017/module1/problem/1.html">Problems-Introduction</option>
      
      <option  value="117103017/module2/problem/1.html">Problems-Markov Process and Markov Chains</option>
      
      <option  value="117103017/module3/problem/1.html">Problems-Basics of Queuing</option>
      
      <option  value="117103017/module4/problem/1.html">Problems- M/M/-/- Type Queues</option>
      
      <option  value="117103017/module5/problem/1.html">Problems-M/G/1 Queue</option>
      
      <option  value="117103017/module7/problem/1.html">Problems - Special Cases of the M/G/1 Queue</option>
      
      <option  value="117103017/module8/problem/1.html">Problems- M/G/1 Queue with Batch Arrivals</option>
      
      <option  value="117103017/module9/problem/1.html">Problems-Priority Operation of the M/G/1 Queue</option>
      
      <option  value="117103017/module10/problem/1.html">Problems-M/G/1/K -Finite Capacity M/G/1 Queue</option>
      
      <option  value="117103017/module13/problem/1.html">Problems- Open and Closed Networks of M/M/m Type Queues</option>
      
      <option  value="117103017/module14/problem/1.html">Problems- Analyzing Closed Networks with Convolution and Mean Value Analysis Algorithms</option>
      
      <option  value="117103017/module15/problem/1.html">Problems-Norton's Theorem, Mixed Networks, QNA</option>
      
      <option  value="117103017/module16/problem/1.html">Problems-Discrete Time Queues</option>
          </select></td>
	...
	<td>  <select name="type1" id="type1" onchange='this.form.submit();'>
      <option  value="#">Select </option>
      <option  value="117108037/module1/lecture1.pdf">Introduction</option>
      
      <option  value="117108037/module1/lecture2.pdf">Geometric Optics</option>
      
      <option  value="117108037/module1/lecture3.pdf">Wave Optics I</option>
      
      <option  value="117108037/module1/lecture4.pdf">Wave Optics II</option>
      
      <option  value="117108037/module1/lecture5.pdf">Magnetic Waves: EM Optics I</option>
      
      <option  value="117108037/module1/lecture6.pdf">Electro-Magnetic Waves: EM Optics II</option>
      
      <option  value="117108037/module2/lecture7.pdf">Photons</option>
      
      <option  value="117108037/module2/lecture8.pdf">Light Matter Interactions & Lasers</option>
      
      <option  value="117108037/module2/lecture9.pdf">Spectroscopies</option>
      
      <option  value="117108037/module2/lecture10.pdf">Optoelectronics</option>
      
      <option  value="117108037/module3/lecture11.pdf">Basic Microscopy</option>
      
      <option  value="117108037/module3/lecture12.pdf">Fluorescence Imaging</option>
      
      <option  value="117108037/module3/lecture13.pdf">Focal Volume Reduction</option>
      
      <option  value="117108037/module3/lecture14.pdf">Fluorescence Techniques</option>
      
      <option  value="117108037/module3/lecture15.pdf">Biomedical Imaging</option>
      
      <option  value="117108037/module3/lecture16.pdf">Optical Manipulation</option>
      
      <option  value="117108037/module4/lecture17.pdf">Biosensors Overview</option>
      
      <option  value="117108037/module4/lecture18.pdf">Labeled DNA Sensors</option>
      
      <option  value="117108037/module4/lecture19.pdf">Bio-Patterning Methods</option>
      
      <option  value="117108037/module4/lecture20.pdf">Microarrays</option>
      
      <option  value="117108037/module4/lecture21.pdf">Label Free Biosensors</option>
      
      <option  value="117108037/module5/Useful-References.pdf">Useful References</option>
          </select></td>
	...
	<td><select name="type1" id="type1" onchange='this.form.submit();'><option  value="#">Select </option>
      ...
      <option  value="117106090/Principles_Of_Communication/index.php">contents</option>
